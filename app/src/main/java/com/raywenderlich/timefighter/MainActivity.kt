...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        // inflate menu, adds options to action bar if present
        menuInflater.inflate(R.menu.menu, menu)
        return true
    }

    // app menu options behaviour
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        // behaviour when "About" selected
    ...
    // called when tapMeButton is clicked, listener in onCreate
    ...
    private fun restoreGame() {
        ...
        // restore timer starting from timeLeft
